    ...
    return (
        <MathJaxContext config={{loader: { load: ["input/asciimath"] }}}>
            <Typography.Title level={1}>
                Методика оценки степени организованности систем обеспечения БДД для города 🏘️
            </Typography.Title>
            <Space  direction="vertical" size="middle" >
                <Card>
                    ...
                    <div style={methodDivStyle}>
                        <p style={methodPStyle}>Для городских систем обеспечения БДД используется 3-х-звенный механизм информационной передачи</p>
                ...
                <Card>
                    ...
                    <div style={methodDivStyle}>
                        ...
                        <p style={methodPCenterStyle}>
                            <MathJax>{"`Q = Q_{RA} + Q_{V} + Q_{D} = ln(1/K_{RA}) + ln(1/K_{V}) + ln(1/K_{D})`"}</MathJax>
                        </p>
                        <p style={methodPStyle}>
